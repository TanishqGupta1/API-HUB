...
- `n8n-nodes-onprintshop/` — TypeScript custom n8n node for OnPrintShop GraphQL API. OAuth2 auth. 22 operations implemented, 33 mutations missing (see `OPS-NODE-GAP-ANALYSIS.md`). Available for legacy flows.
