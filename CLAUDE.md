...
- `n8n-nodes-onprintshop/` — TypeScript custom n8n node for OnPrintShop GraphQL API. OAuth2 auth. 40/40 mutations implemented (see `OPS-NODE-GAP-ANALYSIS.md`). Available for legacy flows.
