...
def _clear_auth_cookie(response: Response) -> None:
    ...
    # samesite, and secure flags that were used when the cookie was set.
    # Without them some browsers (Safari, Firefox strict-mode) won't clear
    # cross-site cookies reliably.
