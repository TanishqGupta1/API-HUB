...
def _build_setProduct_step(
    ...
    inp: dict[str, Any] = {
        ...
        # NOTE: products_sku and products_url are NOT in OPS ProductInput schema
        # on this staging instance (verified June 2026 — OPS returns INVALID_USER_INPUT).
        # products_internal_title carries the supplier SKU. The URL slug is
        # auto-generated by OPS from products_title and cannot be overridden via API.
        "visible": 1,
