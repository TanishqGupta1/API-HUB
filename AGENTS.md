# ⚠️ Canonical home moved

Active development of this codebase now lives in **GraphXCPI/graphx-connect** (https://github.com/GraphXCPI/graphx-connect).

This repo is the legacy/source copy retained during migration — check the new repo for the latest,
push PRs there, and coordinate any changes against that remote's default branch, not this checkout's
origin (`VisualGraphxLLC/API-HUB`).

<!-- GRAPHX-GOVERNANCE-VERSION: 2026.07.12 -->
## GraphX Connect Service Contract

Since this checkout now carries graphx-connect's merged history, its safety rules apply here too.
